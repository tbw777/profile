...
%----------------------------------------------------------------------------------------
    ...
    \begin{minipage}[t]{0.275\textwidth} % 27.5% of the page width for the first row of icons
        ...
        \icon{CodeFork}{12}{\href{https://leetcode.com/tbw777/}{LeetCode}}\\
        \icon{CodeFork}{12}{\href{https://www.codewars.com/users/tbw777}{CodeWars}}\\
    ...
    \begin{minipage}[t]{0.275\textwidth} % 27.5% of the page width for the second row of icons
        ...
        \icon{Whatsapp}{12}{\href{https://wa.me/79167372164}{Click to chat}}\\
