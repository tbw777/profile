...
%----------------------------------------------------------------------------------------
    ...
    \begin{minipage}{0.1\textwidth}
        \begin{figure}[H]
            \efbox{\includegraphics[width=3.5cm]{1}}
        \end{figure}
    \end{minipage}
	\hspace{2cm}
    \begin{minipage}[t]{0.33\textwidth} % 45% of the page width for name
        ...
        {\huge Java/Kotlin desenvolvedor} % Career or current job title
    \end{minipage}
